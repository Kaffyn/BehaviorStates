...
A SoftEngine, a suíte de plugins do Machi, é a aula magna sobre arquitetura de plugins. Ela não é um plugin, é uma **suíte de plugins**. Vamos dissecar cada domínio para entender sua responsabilidade e ver exemplos práticos de como eles funcionam.
